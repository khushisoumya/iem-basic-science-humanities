import { Users, Building2, Landmark, GraduationCap, CheckCircle2, ArrowRight } from 'lucide-react'
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 lg:py-16">
      <div className="text-center mb-10">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-navy">Outcome Development Flow</h2>
      </div>
