...
function ConsultancyServices() {
  return (
    <section className="bg-blue-50/40 py-12 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-navy">Consultancy Services Offered</h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 flex flex-col sm:flex-row gap-4 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
